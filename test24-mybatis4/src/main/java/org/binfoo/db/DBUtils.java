...
public class DBUtils {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(username + ":"+username.substring(0,username.indexOf("-")) + "number:" + username.indexOf("-"));
            System.out.println(password+ ":"+username.substring(0,password.indexOf("-")));
